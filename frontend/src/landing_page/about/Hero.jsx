...
export default function Hero() {
    return (
        <div className="container">
            ...
            <div className="row m-5 border-top hero-txt">
                <div className="col p-4 mt-5">
                    <p>We kick-started operations on the 15th of August, 2010 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company TradeX, a combination of Zero and "Rodha", the Sanskrit word for barrier.</p>
